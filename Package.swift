...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "FPHINfcWidget",
            url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/WIDGET/FPHINfcWidget/0.3.11/FPHINfcWidget.zip",
            checksum: "1c5a64409f0e4f43fc7efbf618b346b13e65b0e8650eb98bf378a69b63c8059c"
        ),
    ]
)
